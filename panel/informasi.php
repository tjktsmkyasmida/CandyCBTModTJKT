...
<div class="panel">
    <div class="panel-header">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#log_apache" data-toggle="tab">Log Apache</a></li>
            <li><a href="#histori" data-toggle="tab">Tutorial</a></li>
            <li><a href="#histori" data-toggle="tab">Edition By</a></li>
    ...
    <div class="panel-body">
        <div class="tab-content">
            ...
            <div class="tab-pane" id="log_apache">
                <div class="panel-body">

                    <?php
                    $file_histori = "../../../../var/log/apache2/access.log";
                    if (file_exists($file_histori)) {
                        $fh = fopen($file_histori, "r");
