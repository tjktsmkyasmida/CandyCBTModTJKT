				...
				<ul>
					<li>
						<a style="color:#fff" href="." class="btn-logout">
							<span ><img src='../dist/svg/home.svg' width='30'></span><br>Dashboard
						</a>
					</li>
					<li>
						<a style="color:#fff" class="btn-logout" href="?pg=pengaturan">
							<span class><img src='../dist/svg/settings.svg' width='30'></span><br>Pengaturan
						</a>
					</li>
					<li>
						<a style="color:#fff" href="logout.php" class="btn-logout"> <span class><img src='../dist/svg/cancel.svg' width='30'></span><br>Keluar</a>
					</li>
				</ul>
			</div>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<?php if ($setting['server'] == 'pusat') : ?>
							<li class=' treeview'>
								<a href='#'>
									<img src='../dist/svg/data_master.svg' width='30'>
						...
						<?php endif ?>
						<li class='treeview'><a href='?pg=siswa'><img src='../dist/svg/peserta_ujian.svg' width='30'> <span>Peserta Ujian</span></a></li>
						<!-- <li class='treeview'>
						...
						<li class='treeview'>
							<a href='#'><img src='../dist/svg/briefcase.svg' width='30'><span> Bank Soal </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
						...
						<li><a href='?pg=statusall'><img src='../dist/svg/siswa_ujian.svg' width='30'> <span>Status Peserta</span></a></li>
						<!-- <li><a href='?pg=jadwal'><i class="fas fa-desktop side-menu-icon fa-fw"></i> <span> Status Ujian</span></a></li> -->
						<li class='treeview'>
							<a href='#'><img src='../dist/svg/survey.svg' width='30'><span> Menu Ujian </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
						...
						<li class='treeview'>
							<a href='#'><img src='../dist/svg/nilai.svg' width='30'><span> Nilai </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
						...
						<li class='treeview'>
							<a href='#'><img src='../dist/svg/print.svg' width='30'><span> Cetak </span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
						...
						<li class='treeview'><a href='?pg=pengumuman'><img src='../dist/svg/advertising.svg' width='30'> <span> Pengumuman</span></a></li>
						<li class='treeview'>
							<a href='#'><img src='../dist/svg/manajemen_user.svg' width='30'> <span>Manajemen User</span><span class='pull-right-container'> <i class='fa fa-angle-down pull-right'></i> </span></a>
							<ul class='treeview-menu'>
						...
						<li class='treeview'><a href='?pg=pengaturan'><img src='../dist/svg/services.svg' width='30'> <span>Pengaturan</span></a></li>
		...
		<footer class='main-footer hidden-xs'>
			<div class='container'>
				<div class='pull-left hidden-xs'>
					<strong>
						<span id='end-sidebar'>
							&copy; 2023 <?= APLIKASI . " v" . VERSI . " r" . REVISI ?> - Modif by InfoEdu17
						</span>
					</strong>
				</div>
