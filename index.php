            ...
            <section class='sidebar'>
                ...
                <div class='user-panel'>
                    ...
                    <div class='pull-left info' style='left:65px'>
                        ...
                        <p>
                            <span class="badge bg-red"><?=$siswa['idpk']?></span>
                            <span class="badge bg-green"><?=$siswa['id_kelas']?></span><br>
                            <!--<span class="badge bg-purple">S-<?=$siswa['sesi']?></span>-->
                        </p>
                    </div>
                </div><br>
                <hr style="margin:0px">
                <ul class='sidebar-menu tree' data-widget='tree'>
                    <li class='header'>Main Menu Peserta</li>
                    <li><a href='<?= $homeurl ?>'><i class='fas fa-tachometer-alt fa-fw  '></i> <span> Dashboard</span></a></li>
                    <li><a href="<?= $homeurl ?>/pengumuman"><i class="fas fa-bell fa-fw"></i> Informasi</a></li>
                    ...
                    <li>
                        <a href="https://wa.me/6282176352272?text=Assalamu'alaikum Pak... Nama, Kelas, Kendalanya apa ?" target="_blank" rel="nofollow">
                            <i class="fa fa-comment"></i>WhatsApp</a>
                    </li>
                    <li>
                        <a href="https://youtube.com/playlist?list=PLOw-cHwSsc_011QPMlaN6Pad7Ipq4pJKK&si=qxJRHSJmiuWByGTf" target="_blank" rel="nofollow">
                            <i class="fa fa-film"></i>Tutorial Video</a>
                    </li>
                    <li>
                        <a href="https://tjkt.smkyasmida.sch.id/category/ujian/" target="_blank" rel="nofollow">
                            <i class="fa fa-book"></i>Manual Book</a>
                    </li>
                    <li><a href='<?= $homeurl ?>#'><span>-------------------------</span></a></li>
                    <li><a href='<?= $homeurl ?>/logout.php'><i class='fa fa-sign-in-alt fa-fw'></i>Log Out</a></li>
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
